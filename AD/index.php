    ...
    <div class="wrapper">
            ...
            <section class="sidebar">
                ...
                <div class="user-panel">
                    ...
                    <div class="pull-left info">
                        <p>
                            <?php echo $_SESSION['fname'] . " <br/>" . $_SESSION['lname']; ?>
                        </p>
                        <p>
                ...
                <ul class="sidebar-menu nav nav-sidebar" data-widget="tree">
                    ...
                    <li class="active" id="liststaffli">
                        <a href="#list_staff" role="tab" data-toggle="tab">
                            <i class="fa fa-list"></i>
                            <span>List Staff</span>
                        </a>
                    </li>
                    <li id="listchemicalli">
                        <a href="#list_chem" role="tab" data-toggle="tab">
                            <i class="fa fa-list"></i>
                            <span>List Chemical</span>
                        </a>
                    </li>
                    <li id="regisstaffli">
                        <a href="#regis_staff" role="tab" data-toggle="tab">
                            <i class="fa fa-user-plus"></i>
                            <span>Register Staff</span>
                        </a>
                    </li>
                    <li id="newchemli">
                        <a href="#new_chem" role="tab" data-toggle="tab">
                            <i class="fa fa-plus"></i>
                            <span>New Chemical List</span>
                        </a>
                    </li>
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2017
                <a href="#">ZeroWaste</a>.</strong> All rights reserved.
        </footer>
