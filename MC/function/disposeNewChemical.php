...
include '../../connection/connection.php';
	...
	$chemicalUserId = $_POST['cserId'];
		...
		$query = "UPDATE chemicalusage SET enddate=now(),remaining_quantity='Dispose',status ='Return' where ciid = ".$chemicaInlId." and cuid = ".$cuid.";";
		$query .= "UPDATE chemicalIn SET status = 'Dispose',remaining_quantity='Dispose' where userid = ".$chemicalUserId." AND ciid = ".$chemicaInlId.";";
